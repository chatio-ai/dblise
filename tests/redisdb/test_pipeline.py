...
async def _schema(facade: RedisFacade) -> AsyncGenerator[Items]:
...
async def test_schema_exists(facade: RedisFacade, schema: Items) -> None:
    await schema.test.assign(Item('test'))
...
async def test_pipeline_entity(facade: RedisFacade, schema: Items, *, transaction: bool) -> None:
...
async def test_pipeline_schema(facade: RedisFacade, schema: Items, *, transaction: bool) -> None:
...
async def test_pipeline_entities(facade: RedisFacade, schema: Items, *, transaction: bool) -> None:
